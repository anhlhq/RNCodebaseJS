...
ThemeManager.setComponentTheme(
  'Text',
  ({italic, underline, overline, lineThrough, customStyle, ...rest}) => {
    let propsColor = null;
    let propsStyle = {};

    const listKeysFontFamily = ['inter'];

    const listKeysFontSize = [
      'xs',
      'sm',
      'base',
      'lg',
    ...
    const listKeysTextAlign = ['auto', 'left', 'right', 'center', 'justify'];
